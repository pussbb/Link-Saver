...
# Generated by qmake (2.01a) (Qt 4.7.0) on: ?? ???. 18 21:33:25 2011
...
SOURCES       = qtsingleapplication/src/qtsingleapplication.cpp \
		...
		settings.cpp \
		import.cpp \
		qt-json/json.cpp moc_qtsingleapplication.cpp \
		moc_qtlocalpeer.cpp \
		moc_linksaver.cpp \
		moc_addurl.cpp \
		moc_pictureflow.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/LinkSaver1.0.0/ && $(COPY_FILE) --parents qtsingleapplication/src/qtsingleapplication.h qtsingleapplication/src/qtlocalpeer.h linksaver.h addurl.h pictureflow.h about.h apps.h settings.h import.h qt-json/json.h .tmp/LinkSaver1.0.0/ && $(COPY_FILE) --parents linkres.qrc .tmp/LinkSaver1.0.0/ && $(COPY_FILE) --parents qtsingleapplication/src/qtsingleapplication.cpp qtsingleapplication/src/qtlocalpeer.cpp main.cpp linksaver.cpp addurl.cpp pictureflow.cpp about.cpp apps.cpp settings.cpp import.cpp qt-json/json.cpp .tmp/LinkSaver1.0.0/ && $(COPY_FILE) --parents linksaver.ui addurl.ui about.ui apps.ui settings.ui import.ui .tmp/LinkSaver1.0.0/ && $(COPY_FILE) --parents lang/linksaver_ru.ts lang/linksaver_def.ts lang/linksaver_en.ts .tmp/LinkSaver1.0.0/ && (cd `dirname .tmp/LinkSaver1.0.0` && $(TAR) LinkSaver1.0.0.tar LinkSaver1.0.0 && $(COMPRESS) LinkSaver1.0.0.tar) && $(MOVE) `dirname .tmp/LinkSaver1.0.0`/LinkSaver1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/LinkSaver1.0.0
