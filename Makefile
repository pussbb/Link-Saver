...
# Generated by qmake (2.01a) (Qt 4.7.0) on: ?? ????. 3 21:03:55 2011
# Project:  LinkSaver.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -spec /usr/share/qt4/mkspecs/linux-g++ CONFIG+=debug QMLJSDEBUGGER_PATH=/usr/share/qtcreator/qml/qmljsdebugger QMLJSDEBUGGER_PATH=/usr/share/qtcreator/qml/qmljsdebugger -o Makefile LinkSaver.pro
#############################################################################
...
SOURCES       = qtsingleapplication/src/qtsingleapplication.cpp \
		...
		qdragtree.cpp moc_qtsingleapplication.cpp \
		moc_qtlocalpeer.cpp \
		moc_linksaver.cpp \
		moc_addurl.cpp \
		moc_pictureflow.cpp \
...
Makefile: LinkSaver.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ CONFIG+=debug QMLJSDEBUGGER_PATH=/usr/share/qtcreator/qml/qmljsdebugger QMLJSDEBUGGER_PATH=/usr/share/qtcreator/qml/qmljsdebugger -o Makefile LinkSaver.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/LinkSaver1.0.0/ && $(COPY_FILE) --parents qtsingleapplication/src/qtsingleapplication.h qtsingleapplication/src/qtlocalpeer.h linksaver.h addurl.h pictureflow.h about.h apps.h settings.h import.h qt-json/json.h xbel/xbelgenerator.h qdragtree.h .tmp/LinkSaver1.0.0/ && $(COPY_FILE) --parents linkres.qrc .tmp/LinkSaver1.0.0/ && $(COPY_FILE) --parents qtsingleapplication/src/qtsingleapplication.cpp qtsingleapplication/src/qtlocalpeer.cpp main.cpp linksaver.cpp addurl.cpp pictureflow.cpp about.cpp apps.cpp settings.cpp import.cpp qt-json/json.cpp xbel/xbelgenerator.cpp qdragtree.cpp .tmp/LinkSaver1.0.0/ && $(COPY_FILE) --parents linksaver.ui addurl.ui about.ui apps.ui settings.ui import.ui .tmp/LinkSaver1.0.0/ && $(COPY_FILE) --parents lang/linksaver_ru.ts lang/linksaver_def.ts lang/linksaver_en.ts lang/linksaver_nl.ts .tmp/LinkSaver1.0.0/ && (cd `dirname .tmp/LinkSaver1.0.0` && $(TAR) LinkSaver1.0.0.tar LinkSaver1.0.0 && $(COMPRESS) LinkSaver1.0.0.tar) && $(MOVE) `dirname .tmp/LinkSaver1.0.0`/LinkSaver1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/LinkSaver1.0.0
...
compiler_moc_header_make_all: moc_qtsingleapplication.cpp moc_qtlocalpeer.cpp moc_linksaver.cpp moc_addurl.cpp moc_pictureflow.cpp moc_about.cpp moc_apps.cpp moc_settings.cpp moc_import.cpp moc_qdragtree.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_qtsingleapplication.cpp moc_qtlocalpeer.cpp moc_linksaver.cpp moc_addurl.cpp moc_pictureflow.cpp moc_about.cpp moc_apps.cpp moc_settings.cpp moc_import.cpp moc_qdragtree.cpp
...
moc_qdragtree.cpp: qdragtree.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) qdragtree.h -o moc_qdragtree.cpp
...
qrc_linkres.cpp: linkres.qrc \
		...
		res/htmlcoverflow/index.html \
		res/htmlcoverflow/bookmark.js
...
qdragtree.o: qdragtree.cpp qdragtree.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qdragtree.o qdragtree.cpp
...
moc_qdragtree.o: moc_qdragtree.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_qdragtree.o moc_qdragtree.cpp
