...
# Generated by qmake (2.01a) (Qt 4.7.0) on: ?? ???. 10 21:00:23 2011
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/LinkSaver1.0.0/ && $(COPY_FILE) --parents qtsingleapplication/src/qtsingleapplication.h qtsingleapplication/src/qtlocalpeer.h linksaver.h addurl.h pictureflow.h about.h apps.h .tmp/LinkSaver1.0.0/ && $(COPY_FILE) --parents linkres.qrc .tmp/LinkSaver1.0.0/ && $(COPY_FILE) --parents qtsingleapplication/src/qtsingleapplication.cpp qtsingleapplication/src/qtlocalpeer.cpp main.cpp linksaver.cpp addurl.cpp pictureflow.cpp about.cpp apps.cpp .tmp/LinkSaver1.0.0/ && $(COPY_FILE) --parents linksaver.ui addurl.ui about.ui apps.ui .tmp/LinkSaver1.0.0/ && $(COPY_FILE) --parents lang/linksaver_ru.ts lang/linksaver_def.ts /./lang/linksaver_en.ts .tmp/LinkSaver1.0.0/ && (cd `dirname .tmp/LinkSaver1.0.0` && $(TAR) LinkSaver1.0.0.tar LinkSaver1.0.0 && $(COMPRESS) LinkSaver1.0.0.tar) && $(MOVE) `dirname .tmp/LinkSaver1.0.0`/LinkSaver1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/LinkSaver1.0.0
