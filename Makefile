...
# Generated by qmake (2.01a) (Qt 4.7.0) on: ?? ???. 15 13:39:41 2011
...
SOURCES       = qtsingleapplication/src/qtsingleapplication.cpp \
		...
		about.cpp \
		apps.cpp \
		settings.cpp moc_qtsingleapplication.cpp \
		moc_qtlocalpeer.cpp \
		moc_linksaver.cpp \
		moc_addurl.cpp \
		moc_pictureflow.cpp \
...
$(TARGET): ui_linksaver.h ui_addurl.h ui_about.h ui_apps.h ui_settings.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/LinkSaver1.0.0/ && $(COPY_FILE) --parents qtsingleapplication/src/qtsingleapplication.h qtsingleapplication/src/qtlocalpeer.h linksaver.h addurl.h pictureflow.h about.h apps.h settings.h .tmp/LinkSaver1.0.0/ && $(COPY_FILE) --parents linkres.qrc .tmp/LinkSaver1.0.0/ && $(COPY_FILE) --parents qtsingleapplication/src/qtsingleapplication.cpp qtsingleapplication/src/qtlocalpeer.cpp main.cpp linksaver.cpp addurl.cpp pictureflow.cpp about.cpp apps.cpp settings.cpp .tmp/LinkSaver1.0.0/ && $(COPY_FILE) --parents linksaver.ui addurl.ui about.ui apps.ui settings.ui .tmp/LinkSaver1.0.0/ && $(COPY_FILE) --parents lang/linksaver_ru.ts lang/linksaver_def.ts lang/linksaver_en.ts .tmp/LinkSaver1.0.0/ && (cd `dirname .tmp/LinkSaver1.0.0` && $(TAR) LinkSaver1.0.0.tar LinkSaver1.0.0 && $(COMPRESS) LinkSaver1.0.0.tar) && $(MOVE) `dirname .tmp/LinkSaver1.0.0`/LinkSaver1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/LinkSaver1.0.0
...
compiler_moc_header_make_all: moc_qtsingleapplication.cpp moc_qtlocalpeer.cpp moc_linksaver.cpp moc_addurl.cpp moc_pictureflow.cpp moc_about.cpp moc_apps.cpp moc_settings.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_qtsingleapplication.cpp moc_qtlocalpeer.cpp moc_linksaver.cpp moc_addurl.cpp moc_pictureflow.cpp moc_about.cpp moc_apps.cpp moc_settings.cpp
...
compiler_uic_make_all: ui_linksaver.h ui_addurl.h ui_about.h ui_apps.h ui_settings.h
compiler_uic_clean:
	-$(DEL_FILE) ui_linksaver.h ui_addurl.h ui_about.h ui_apps.h ui_settings.h
